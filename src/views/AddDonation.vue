<template>
  <div class="welcome mx-auto lg:w-2/4 md:w-3/4 mt-10 mb-20 px-4 text-center">
    <p
      class="text-center text-2xl md:text-3xl text-gray-400 font-serif font-bold text-gray-800"
    >
    ...
    <div class="p-2 border-2 bg-white border-yellow-500 mt-8 shadow-xl">
      <form @submit.prevent="handleSubmit">
        <div class=" pt-4 pb-4 px-4 bg-gray-300">
          <div
            class="w-full flex flex-col md:flex-row justify-between gap-2 my-3 items-center"
          >
            <div
              class="py-2 px-3 w-full md:w-1/3  bg-yellow-500 border-2 shadow-sm border-gray-600 text-xl font-bold focus:ring-2 focus:ring-yellow-700  "
            >
              10.000
            </div>
            <div
        ...
        <div class="mt-8 border-4 border-gray-300 p-4">
          ...
          <div class="mt-6">
            <p class="text-left pl-3 text-md font-bold mt-3 text-gray-400">
              Pesan
            </p>
            <textarea
        ...
        <div
          class=" grid gap-4 md:flex md:flex-row md:items-center justify-around items-baseline mt-6 border-4 border-gray-300 p-2 "
        >
          <div class="p-2">
            <img
              class="h-6 mb-3"
        ...
        <button
          class=" mt-12 w-full max-w-md py-3 px-3 focus:outline-none focus:bg-yellow-600 rounded-none bg-yellow-500 text-xl font-semibold shadow-lg transform hover:-translate-y-1 ease-in-out duration-700 "
        >
          Kirim
        </button>
      </form>
