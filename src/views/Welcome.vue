<template>
  ...
  <div class="relative">
          <!-- <img class="absolute inset-auto max-w-xl" src="../assets/blob_8-5-986575.svg"> -->
      <div class=" mb-12 px-12 pt-12 min-h-screen mx-auto max-w-5x">
        <div class="flex flex-col md:flex-row gap-10 items-center justify-center  mx-auto">
          <div class="header md:max-w-md">
              ...
              <h2 class="text-center md:text-left text-2xl md:text-3xl font-serif font-bold text-turkis ">
                Halo,Selamat datang
              </h2>
