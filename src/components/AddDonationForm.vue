  ...
  <form @submit.prevent="handleSubmit">
    <div class=" border-4 border-gray-300 pt-4 pb-4 px-4 bg-gray-400">
      <div class="flex flex-col sm:flex-row sm:flex justify-around my-3 ">
        <div
          class="mt-2 md:mt-0 w-1/3 mx-2 bg-yellow-500 border-2  shadow-sm border-gray-600 text-xl font-bold focus:ring-2 focus:ring-yellow-700 py-2 px-3"
        >
          10.000
        </div>
        <div
          class="py-2 px-3 mt-2 md:mt-0 w-1/3 mx-2 bg-yellow-500 border-2  shadow-sm border-gray-600 text-xl font-bold focus:ring-2 focus:ring-yellow-700 "
        >
          50.000
        </div>
        <div
    ...
    <div
      class="flex flex-col md:flex-row md:items-center justify-around items-baseline mt-6 border-4 border-gray-300 p-2"
    >
      <div class="p-2">
